    ...
    >
      ...
      <div className="w-full mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
          ...
          {/* Tombol Admin Baru: Menggunakan React Router Link agar transisi 0 detik */}
          <Link 
            to="/admin" 
            className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/[0.03] border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all font-mono text-[10px] tracking-widest text-white/50 hover:text-white group outline-none"
            title="System Administration"
          >
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:stroke-[#143DED] transition-colors">
