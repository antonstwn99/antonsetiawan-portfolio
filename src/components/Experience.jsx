        ...
        <div className="w-full xl:w-[75%] flex flex-col gap-12 mt-8 xl:mt-0">
          ...
          <div className="relative">
            <h3 className="font-heading text-lg font-bold text-white mb-6 flex items-center gap-3">
              <span className="w-2 h-2 rounded-full bg-[#143DED]"></span>
              Academic Background
            </h3>
            <div className="grid grid-cols-1 gap-6 relative z-10">
              {EDUCATION_DATA.map((item, index) => (
                <motion.div
                  ...
                  className="flex flex-col group relative bg-gradient-to-r from-[#143DED]/10 to-transparent p-6 md:p-8 rounded-2xl border border-[#143DED]/20 hover:border-[#143DED]/50 transition-colors overflow-hidden shadow-[0_8px_32px_rgba(20,61,237,0.1)]"
                >
                  {/* Decorative Glow & GPA Ribbon */}
                  ...
                  <p className="font-body text-sm font-bold text-[#143DED] mb-1">
                    {item.institution}
                  </p>
                  ...
                  <div className="flex items-start gap-3 mt-2">
                    <div className="w-8 h-8 rounded-full bg-amber-500/10 border border-amber-500/30 flex items-center justify-center shrink-0 mt-0.5">
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path></svg>
                    </div>
                    <p className="font-body text-sm md:text-base text-white/80 leading-relaxed font-medium">
                      {item.desc}
                    </p>
                  </div>
                </motion.div>
